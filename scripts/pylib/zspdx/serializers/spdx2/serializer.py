...
""")
            ...
            if cmake_generator:
                f.write(
                    "FilesAnalyzed: false\n"
                    f"PackageComment: <text>Build tool: CMake {cmake_version or ''} "
                    f"with generator {cmake_generator}</text>\n\n"
                )
            else:
                f.write(
                    "FilesAnalyzed: false\n"
                    f"PackageComment: <text>Build tool: CMake {cmake_version or ''}</text>\n\n"
                )
...
""")
            ...
            f.write(
                "FilesAnalyzed: false\n"
                f"PackageComment: <text>{' | '.join(comment_parts)}</text>\n\n"
            )
