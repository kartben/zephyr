...
""")
    ...
    def _resolve_cpe_metadata(self, component):
        ...
        Returns local copies so the component is left untouched. The component's
        own name is never overridden: it identifies the package across both
        specification families and is what relationships refer to, whereas the CPE
        product is the upstream product name (e.g. "mbed_tls" for "mbedtls-deps").
        """
