...
""")
    ...
    def _write_custom_licenses(self, f, doc: SBOMDocument):
        ...
        Every license identifier used anywhere in the document that is not on the SPDX
        license list has to be declared here, or the document does not validate. That
        includes package-level licenses, which a module can declare in its
        :file:`zephyr/module.yml`, not just the ones detected inside files.
        """
