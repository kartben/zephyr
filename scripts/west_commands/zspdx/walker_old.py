...
class Walker:
    ...
    def __init__(self, cfg):
        ...
        self.component_modules = {}  # module_name -> SBOMComponent
    ...
    def setupBuildComponents(self):
        """Set up build artifact components (targets will be created in walkTargets)."""
        # Note: Build target components are created dynamically in walkTargets()
        # We'll create a relationship to zephyr_final later
        pass
