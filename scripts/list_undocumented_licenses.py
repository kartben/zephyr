...
# Importing the shim backports the custom_properties API this script relies on (annotations
# keeping the REUSE.toml keys reuse does not recognise, such as Zephyr-Description) onto the
# released reuse library. It is a no-op once reuse provides the API natively.
import reuse_custom_properties  # noqa: F401
