...
def test_alternatives_do_not_require_either_module(analyze):
    ...
    required = analyze("""\
        ...
        """, config="CONFIG_CRYPTO_BACKEND=y\n")
...
def test_the_requirements_are_what_the_build_reads(tmp_path):
    ...
    assert module_requirements.module_names_from_file(modules) == ["hal_tdk",
                                                                  "lora-basics-modem"]
