...
function(sysbuild_cache)
  ...
  set(board_string "${BOARD}")
  if(DEFINED BOARD_REVISION AND BOARD_REVISION)
    string(APPEND board_string "@${BOARD_REVISION}")
  endif()
  if(DEFINED BOARD_QUALIFIERS AND BOARD_QUALIFIERS)
    string(APPEND board_string "/${BOARD_QUALIFIERS}")
  endif()
  list(APPEND sysbuild_cache_strings "BOARD:STRING=${board_string}\n")
