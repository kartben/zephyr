...
/**
 * @file
 * @brief Header file for MCUmgr SMP.
 * @ingroup mcumgr_smp
 */
...
/**
 * @brief Simple Management Protocol (SMP).
 * @defgroup mcumgr_smp SMP
 * @ingroup mcumgr
 *
...
/** @brief CBOR reader backed by a net_buf, used to decode SMP requests. */
...
/** @brief CBOR writer backed by a net_buf, used to encode SMP responses. */
 ...
 */
struct smp_streamer {
	/** Transport used to receive the request and send the response. */
	struct smp_transport *smpt;
	/** CBOR reader for the inbound request. */
	struct cbor_nb_reader *reader;
	/** CBOR writer for the outbound response. */
