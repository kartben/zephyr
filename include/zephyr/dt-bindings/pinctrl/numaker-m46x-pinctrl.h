...
/**
 * @addtogroup numaker_pinctrl Nuvoton NuMaker pin control helpers
 ...
 * @ingroup numaker_pinctrl
 *
 * The macros follow the following naming convention:
 * @c \<PORT\>\<PIN\>MFP\_\<FUNCTION\>.
 *
 * For example, @c PB12MFP_UART0_RXD corresponds to the @c UART0_RXD function
 * routed to port @c B pin @c 12.
 *
 * @code{.dts}
