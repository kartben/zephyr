/**
 * @file
 * @brief ST LSM6DSO IMU Devicetree constants
 */
...
/**
 * @defgroup lsm6dso_dt_api ST LSM6DSO Devicetree options
 * @ingroup sensor_interface
 * @{
 */

/**
 * @defgroup lsm6dso_accel_power_modes Accelerometer power modes
 * @{
 */
#define LSM6DSO_DT_XL_HP_MODE			0 /**< High performance */
#define LSM6DSO_DT_XL_LP_NORMAL_MODE		1 /**< Low power / normal mode */
#define LSM6DSO_DT_XL_ULP_MODE			2 /**< Ultra-low power */
/** @} */

/**
 * @defgroup lsm6dso_gyro_power_modes Gyroscope power modes
 * @{
 */
#define LSM6DSO_DT_GY_HP_MODE			0 /**< High performance */
#define LSM6DSO_DT_GY_NORMAL_MODE		1 /**< Normal mode */
/** @} */

/**
 * @defgroup lsm6dso_accel_range Accelerometer full-scale range
 * @{
 */
...
/**
 * @defgroup lsm6dso_gyro_range Gyroscope full-scale range
 * @{
 */
...
/**
 * @defgroup lsm6dso_odr Output data rates
 * @{
 */
...
#define LSM6DSO_DT_ODR_1Hz6			0xb /**< 1.6 Hz (ultra-low power) */
/** @} */

/**
 * @defgroup lsm6dso_lp_filter Low-pass filter ODR divisor
 * @{
 */
...
/**
 * @defgroup lsm6dso_tap_mode Tap detection mode
 * @{
 */
