/**
 * @file
 * @brief ST LSM6DSV320X sensor Devicetree constants
 */
...
/**
 * @defgroup lsm6dsv320x_dt_api ST LSM6DSV320X Devicetree options
 * @ingroup sensor_interface
 * @{
 */

/**
 * @defgroup lsm6dsv320x_hg_xl_odr High-g accelerometer output data rates
 * @{
 */
...
/**
 * @defgroup lsm6dsv320x_accel_range Accelerometer full-scale range
 * @{
 */
...
/**
 * @defgroup lsm6dsv320x_gyro_range Gyroscope full-scale range
 * @{
 */
