/**
 * @file
 * @brief ST IIS2ICLX inclinometer Devicetree constants
 */
...
/**
 * @defgroup iis2iclx_dt_api ST IIS2ICLX Devicetree options
 * @ingroup sensor_interface
 * @{
 */

/**
 * @defgroup iis2iclx_accel_range Accelerometer full-scale range
 * @{
 */
...
/**
 * @defgroup iis2iclx_odr Output data rates
 * @{
 */
