/**
 * @file
 * @brief ST LSM6DSV16X sensor Devicetree constants
 */
...
/**
 * @defgroup lsm6dsv16x_dt_api ST LSM6DSV16X Devicetree options
 * @ingroup sensor_interface
 * @{
 */

/**
 * @defgroup lsm6dsv16x_accel_range Accelerometer full-scale range
 * @{
 */
...
/**
 * @defgroup lsm6dsv16x_gyro_range Gyroscope full-scale range
 * @{
 */
