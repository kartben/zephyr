...
/**
 * @file
 * @brief Peripheral reset identifiers for Nuvoton NPCX9
 * @ingroup reset_controller_npcx9
 */
...
/**
 * @defgroup reset_controller_npcx9 Nuvoton NPCX9 reset controller helpers
 * @brief Nuvoton NPCX9 reset controller helpers
 ...
 * is the NPCX9 peripheral name (for example, @c NPCX_RESET_ADC resets the ADC).
 * @{
 */
