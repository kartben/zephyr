...
/**
 * @file
 * @brief Shell backend management API.
 */
 ...
 *
 * @param[in] idx Backend index.
 *
 * @return Pointer to the shell backend instance at the given index.
 */
...
/**
 * @brief Get number of registered shell backends.
 *
 * @return Number of registered shell backends.
 */
 ...
 *
 * @param[in] backend_name Name of the backend as defined by SHELL_DEFINE.
 *
 * @return Pointer to the shell backend instance if found, NULL otherwise.
 */
