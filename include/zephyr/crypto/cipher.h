 ...
 *
 * @param[in,out] ctx Cipher session context.
 * @param[in,out] pkt Packet containing input and output buffers.
 *
 ...
 * @param[in,out] ctx Cipher session context.
 * @param[in,out] pkt Packet containing input and output buffers.
 * @param[in] iv Initialization vector for this operation. The buffer must
 ...
 * @param[in,out] ctx Cipher session context.
 * @param[in,out] pkt Packet containing input and output buffers.
 * @param[in] ctr Initial counter bytes for this operation. For split-counter
 ...
 *
 * @param[in,out] ctx Cipher session context.
 * @param[in,out] pkt Packet containing input, output, associated data, and
 * authentication tag buffers.
 * @param[in] nonce Nonce for this operation. The buffer must remain valid for
 ...
 * session cipher mode.
 *
 * @param[in] completed Completed cipher packet.
