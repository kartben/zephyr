...
__subsystem struct crypto_driver_api {
	/** @driver_ops_mandatory @copybrief crypto_query_hwcaps */
	crypto_api_query_hw_caps query_hw_caps;

	/** @driver_ops_mandatory @copybrief cipher_begin_session */
	crypto_api_cipher_begin_session cipher_begin_session;

	/** @driver_ops_mandatory @copybrief cipher_free_session */
	crypto_api_cipher_free_session cipher_free_session;

	/** @driver_ops_optional @copybrief cipher_callback_set */
	crypto_api_cipher_async_callback_set cipher_async_callback_set;

	/** @driver_ops_mandatory @copybrief hash_begin_session */
	crypto_api_hash_begin_session hash_begin_session;

	/** @driver_ops_mandatory @copybrief hash_free_session */
	crypto_api_hash_free_session hash_free_session;

	/** @driver_ops_optional @copybrief hash_callback_set */
