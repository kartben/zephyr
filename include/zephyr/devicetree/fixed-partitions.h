...
#ifndef ZEPHYR_INCLUDE_DEVICETREE_FIXED_PARTITIONS_H_
#define ZEPHYR_INCLUDE_DEVICETREE_FIXED_PARTITIONS_H_
...
#endif /* ZEPHYR_INCLUDE_DEVICETREE_FIXED_PARTITIONS_H_ */
