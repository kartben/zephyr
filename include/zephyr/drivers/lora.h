...
__subsystem struct lora_driver_api {
	...
	/** @driver_ops_optional @copybrief lora_api_cad */
	lora_api_cad cad;
	/** @driver_ops_optional @copybrief lora_api_cad_async */
	lora_api_cad_async cad_async;
	/** @driver_ops_optional @copybrief lora_api_recv_duty_cycle_async */
