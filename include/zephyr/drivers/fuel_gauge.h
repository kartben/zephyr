...
__subsystem struct fuel_gauge_driver_api {
	 ...
	 */
	/** @driver_ops_optional @copybrief fuel_gauge_get_property_t */
	fuel_gauge_get_property_t get_property;
	/** @driver_ops_optional @copybrief fuel_gauge_set_property_t */
	fuel_gauge_set_property_t set_property;
	/** @driver_ops_optional @copybrief fuel_gauge_get_buffer_property_t */
	fuel_gauge_get_buffer_property_t get_buffer_property;
	/** @driver_ops_optional @copybrief fuel_gauge_battery_cutoff_t */
