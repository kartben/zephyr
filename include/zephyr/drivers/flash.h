...
__subsystem struct flash_driver_api {
	/** @driver_ops_mandatory @copybrief flash_api_read */
	flash_api_read read;
	/** @driver_ops_mandatory @copybrief flash_api_write */
	flash_api_write write;
	/** @driver_ops_optional @copybrief flash_api_erase */
	flash_api_erase erase;
	/** @driver_ops_mandatory @copybrief flash_api_get_parameters */
	flash_api_get_parameters get_parameters;
	/** @driver_ops_optional @copybrief flash_api_get_size */
	flash_api_get_size get_size;
#if defined(CONFIG_FLASH_PAGE_LAYOUT) || defined(__DOXYGEN__)
	/**
	 * @driver_ops_mandatory @copybrief flash_page_foreach
	...
	/**
	 * @driver_ops_optional @copybrief flash_api_sfdp_read
	 * @kconfig_dep{CONFIG_FLASH_JESD216_API}
	 */
	flash_api_sfdp_read sfdp_read;
	/**
	 * @driver_ops_optional @copybrief flash_api_read_jedec_id
	 * @kconfig_dep{CONFIG_FLASH_JESD216_API}
	 */
	...
	/**
	 * @driver_ops_optional @copybrief flash_api_ex_op
