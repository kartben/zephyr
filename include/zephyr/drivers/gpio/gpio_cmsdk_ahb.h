...
/** ARM LTD CMSDK AHB General Purpose Input/Output (GPIO) register map */
...
/**
 * @brief Configure the pins of a CMSDK AHB GPIO port.
 *
 * @param dev CMSDK AHB GPIO port device
 * @param mask Bitmask of the pins to configure
 * @param flags Standard GPIO configuration flags, e.g. GPIO_INPUT or GPIO_OUTPUT
 *
 * @retval 0 If successful
 * @retval -ENOTSUP if any of the flags is not supported by the port
 */
