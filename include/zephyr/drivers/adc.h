...
__subsystem struct adc_driver_api {
	/** @driver_ops_mandatory @copybrief adc_api_channel_setup */
	adc_api_channel_setup channel_setup;
	/** @driver_ops_mandatory @copybrief adc_api_read */
	adc_api_read          read;
#if defined(CONFIG_ADC_ASYNC) || defined(__DOXYGEN__)
	/**
	 * @driver_ops_mandatory @copybrief adc_api_read_async
	...
	/**
	 * @driver_ops_mandatory @copybrief adc_api_submit
	 * @kconfig_dep{CONFIG_ADC_STREAM}
	 */
	adc_api_submit    submit;
	/**
	 * @driver_ops_optional @copybrief adc_api_get_decoder
	 * @kconfig_dep{CONFIG_ADC_STREAM}
	 */
