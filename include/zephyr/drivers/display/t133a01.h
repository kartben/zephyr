 ...
 * @brief Palette definitions for the T133A01 Spectra 6 e-ink display
 */
 ...
 * @brief T133A01 6-color e-ink display controller device-specific API extension
 * @since 4.5.0
 * @version 0.1.0
 * @ingroup display_interface
 * @{
...
#define T133A01_COLOR_PALETTE_SIZE 7 /**< Number of colors in palette, including empty slot */
/** @} */
