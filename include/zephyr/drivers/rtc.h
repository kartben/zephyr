 ...
 * @see rtc_set_time() for argument descriptions.
 */
 ...
 * @see rtc_get_time() for argument descriptions.
 */
 ...
 * @see rtc_alarm_get_supported_fields() for argument descriptions.
 */
 ...
 * @see rtc_alarm_set_time() for argument descriptions.
 */
 ...
 * @see rtc_alarm_get_time() for argument descriptions.
 */
 ...
 * @see rtc_alarm_is_pending() for argument descriptions.
 */
 ...
 * @see rtc_alarm_set_callback() for argument descriptions.
 */
 ...
 * @see rtc_update_set_callback() for argument descriptions.
 */
 ...
 * @see rtc_set_calibration() for argument descriptions.
 */
 ...
 * @see rtc_get_calibration() for argument descriptions.
 */
...
__subsystem struct rtc_driver_api {
	/**
	 * @driver_ops_mandatory @copybrief rtc_api_set_time
	 */
	rtc_api_set_time set_time;
	/**
	 * @driver_ops_mandatory @copybrief rtc_api_get_time
	 */
	rtc_api_get_time get_time;
#if defined(CONFIG_RTC_ALARM) || defined(__DOXYGEN__)
	/**
	 * @driver_ops_optional @copybrief rtc_api_alarm_get_supported_fields
	 * @kconfig_dep{CONFIG_RTC_ALARM}
	 */
	rtc_api_alarm_get_supported_fields alarm_get_supported_fields;
	/**
	 * @driver_ops_optional @copybrief rtc_api_alarm_set_time
	 * @kconfig_dep{CONFIG_RTC_ALARM}
	 */
	rtc_api_alarm_set_time alarm_set_time;
	/**
	 * @driver_ops_optional @copybrief rtc_api_alarm_get_time
	 * @kconfig_dep{CONFIG_RTC_ALARM}
	 */
	rtc_api_alarm_get_time alarm_get_time;
	/**
	 * @driver_ops_optional @copybrief rtc_api_alarm_is_pending
	 * @kconfig_dep{CONFIG_RTC_ALARM}
	 */
	rtc_api_alarm_is_pending alarm_is_pending;
	/**
	 * @driver_ops_optional @copybrief rtc_api_alarm_set_callback
	 * @kconfig_dep{CONFIG_RTC_ALARM}
	 */
	...
	/**
	 * @driver_ops_optional @copybrief rtc_api_update_set_callback
	...
	/**
	 * @driver_ops_optional @copybrief rtc_api_set_calibration
	 * @kconfig_dep{CONFIG_RTC_CALIBRATION}
	 */
	rtc_api_set_calibration set_calibration;
	/**
	 * @driver_ops_optional @copybrief rtc_api_get_calibration
	 * @kconfig_dep{CONFIG_RTC_CALIBRATION}
	 */
