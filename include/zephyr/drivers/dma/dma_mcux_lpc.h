...
/**
 * @file
 * @brief Header file for NXP LPC DMA driver hardware trigger attributes.
 ...
 * occur.
 *
 * @param pwr Burst power exponent.
 * @return Burst power attribute for the dma_slot field.
 */
#define LPC_DMA_BURSTPOWER(pwr) (((pwr) & 0x7) << 5)


/**
 * Extract the burst power setting from a dma_slot value.
 *
 * @param slot Value of the dma_slot field.
 * @return Burst power exponent.
 */
