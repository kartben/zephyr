...
enum dma_attribute_type {
	DMA_ATTR_BUFFER_ADDRESS_ALIGNMENT, /**< Required alignment of buffer addresses, in bytes. */
	DMA_ATTR_BUFFER_SIZE_ALIGNMENT,    /**< Required alignment of buffer sizes, in bytes. */
	DMA_ATTR_COPY_ALIGNMENT,           /**< Required alignment of memory-to-memory copies, in bytes. */
	DMA_ATTR_MAX_BLOCK_COUNT,          /**< Maximum number of blocks in a single transfer. */
};
