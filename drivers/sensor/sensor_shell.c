...
#define SENSOR_GET_HELP                                                                            \
	SHELL_HELP("Get sensor data.\n"                                                            \
		   "Channel names are optional. All channels are read "                            \
		   "when no channels are provided.",                                               \
		   "<device_name> [channel name 0] .. [channel name N]")

#define SENSOR_STREAM_HELP                                                                         \
	SHELL_HELP("Start/stop streaming sensor data. Data ready trigger will be used if no "      \
