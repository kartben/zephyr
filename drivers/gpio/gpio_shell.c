...
SHELL_STATIC_SUBCMD_SET_CREATE(
	...
	SHELL_CMD_ARG(
		...
		SHELL_HELP("Configure GPIO pin",
			   "gpio conf <device> <pin> <configuration <i|o>[u|d][h|l][0|1]> [vendor "
			   "specific]\n"
			   "<i|o> - input|output\n"
	...
	SHELL_CMD_ARG(get, &sub_gpio_dev,
		      SHELL_HELP("Get GPIO pin value", "gpio get <device> <pin>"), cmd_gpio_get, 3,
		      0),
	SHELL_CMD_ARG(set, &sub_gpio_dev,
		      SHELL_HELP("Set GPIO pin value", "gpio set <device> <pin> <level 0|1>"),
		      cmd_gpio_set, 4, 0),
	SHELL_COND_CMD_ARG(CONFIG_GPIO_SHELL_TOGGLE_CMD, toggle, &sub_gpio_dev,
			   SHELL_HELP("Toggle GPIO pin", "gpio toggle <device> <pin>"),
			   cmd_gpio_toggle, 3, 0),
	SHELL_CMD(devices, NULL, SHELL_HELP("List all GPIO devices", "gpio devices"),
		  cmd_gpio_devices),
	SHELL_COND_CMD_ARG(CONFIG_GPIO_SHELL_BLINK_CMD, blink, &sub_gpio_dev,
			   SHELL_HELP("Blink GPIO pin", "gpio blink <device> <pin>"),
			   cmd_gpio_blink, 3, 0),
	SHELL_COND_CMD_ARG(CONFIG_GPIO_SHELL_INFO_CMD, info, &sub_gpio_dev,
			   SHELL_HELP("GPIO Information", "gpio info [device]"), cmd_gpio_info, 1,
			   1),
