...
For more information about interfacing the GM02S module and the LTE IoT 10 Click,
...
Set ``--shield mikroe_lte_iot10_click`` when you invoke ``west build``. For
example:

.. zephyr-app-commands::
   :zephyr-app: samples/net/lte
