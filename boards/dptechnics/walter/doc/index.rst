...
.. tabs::
   ...
   .. group-tab:: ``walter/esp32s3/appcpu``

      .. include:: /boards/_catalog/walter/walter_esp32s3_appcpu.rst
         :start-after: :orphan:

   .. group-tab:: ``walter/esp32s3/procpu``

      .. include:: /boards/_catalog/walter/walter_esp32s3_procpu.rst
         :start-after: :orphan:
