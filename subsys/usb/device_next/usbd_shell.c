...
SHELL_STATIC_SUBCMD_SET_CREATE(device_cmds,
	SHELL_CMD_ARG(pid, NULL,
		      SHELL_HELP("Set device Product ID", "<idProduct>"),
		      cmd_device_pid, 2, 0),
	SHELL_CMD_ARG(vid, NULL,
		      SHELL_HELP("Set device Vendor ID", "<idVendor>"),
		      cmd_device_vid, 2, 0),
	SHELL_CMD_ARG(bcd_usb, &dsub_config_speed,
		      SHELL_HELP("Set device USB specification version", "<speed> <bcdUSB>"),
		      cmd_device_bcd_usb, 3, 0),
	SHELL_CMD_ARG(triple, &dsub_config_speed,
		      SHELL_HELP("Set device code triple",
...
SHELL_STATIC_SUBCMD_SET_CREATE(config_cmds,
	SHELL_CMD_ARG(add, &dsub_config_name,
		      SHELL_HELP("Add a pre-defined configuration", "<configuration_name>"),
		      cmd_config_add, 2, 0),
	SHELL_CMD_ARG(power, &dsub_config_speed,
		      SHELL_HELP("Set the bMaxPower", "<speed> <configuration_value> <bMaxPower>"),
		      cmd_config_power, 4, 0),
	SHELL_CMD_ARG(set-rwup, &dsub_config_speed,
		      SHELL_HELP("Set Remote Wakeup bit", "<speed> <configuration_value>"),
		      cmd_config_set_rwup, 3, 0),
	SHELL_CMD_ARG(clear-rwup, &dsub_config_speed,
		      SHELL_HELP("Clear Remote Wakeup bit", "<speed> <configuration_value>"),
		      cmd_config_clear_rwup, 3, 0),
	SHELL_CMD_ARG(selfpowered, &dsub_config_speed,
		      SHELL_HELP("Set Self-power bit", "<speed> <configuration_value>"),
		      cmd_config_selfpowered, 3, 0),
	SHELL_CMD_ARG(buspowered, &dsub_config_speed,
		      SHELL_HELP("Clear Self-power bit", "<speed> <configuration_value>"),
...
SHELL_STATIC_SUBCMD_SET_CREATE(class_cmds,
	SHELL_CMD_ARG(register, &dsub_node_name,
		      SHELL_HELP("Register class instance",
				 "<name> <speed> <configuration_value>"),
		      cmd_register, 4, 0),
	SHELL_CMD_ARG(unregister, &dsub_node_name,
		      SHELL_HELP("Unregister class instance",
				 "<name> <speed> <configuration_value>"),
		      cmd_unregister, 4, 0),
	SHELL_SUBCMD_SET_END
);
...
SHELL_STATIC_SUBCMD_SET_CREATE(sub_usbd_cmds,
	SHELL_CMD_ARG(defstr, NULL,
		      SHELL_HELP("Add default string descriptors", ""),
		      cmd_usbd_default_strings, 1, 0),
	SHELL_CMD_ARG(defcfg, NULL,
		      SHELL_HELP("Initialize default configuration with all available classes", ""),
		      cmd_usbd_default_config, 1, 0),
	SHELL_CMD_ARG(init, NULL,
		      SHELL_HELP("Initialize USB device support", ""),
		      cmd_usbd_init, 1, 0),
	SHELL_CMD_ARG(enable, NULL,
		      SHELL_HELP("Enable USB device support", ""),
		      cmd_usbd_enable, 1, 0),
	SHELL_CMD_ARG(disable, NULL,
		      SHELL_HELP("Disable USB device support", ""),
		      cmd_usbd_disable, 1, 0),
	SHELL_CMD_ARG(shutdown, NULL,
		      SHELL_HELP("Shutdown USB device support", ""),
		      cmd_usbd_shutdown, 1, 0),
	SHELL_CMD_ARG(select, &dsub_context_name,
		      SHELL_HELP("Select context used by the shell",
				 "<USB_device_context_name>"),
		      cmd_select, 2, 0),
	SHELL_CMD_ARG(device, &device_cmds,
		      SHELL_HELP("Device commands", "<pid|vid|bcd_usb|triple>"),
		      NULL, 1, 0),
	SHELL_CMD_ARG(config, &config_cmds,
		      SHELL_HELP("Configuration commands",
				 "<add|power|set-rwup|clear-rwup|selfpowered|buspowered>"),
		      NULL, 1, 0),
	SHELL_CMD_ARG(class, &class_cmds,
		      SHELL_HELP("Class commands", "<register|unregister>"),
		      NULL, 1, 0),
	SHELL_CMD_ARG(wakeup, NULL,
		      SHELL_HELP("Signal remote wakeup", ""),
