...
SHELL_STATIC_SUBCMD_SET_CREATE(desc_cmds,
	SHELL_CMD_ARG(device, NULL,
		      SHELL_HELP("Get device descriptor", "<addr>"),
		      cmd_desc_device, 2, 0),
	SHELL_CMD_ARG(configuration, NULL,
		      SHELL_HELP("Get configuration descriptor", "<addr> <index>"),
		      cmd_desc_config, 3, 0),
	SHELL_CMD_ARG(string, NULL,
		      SHELL_HELP("Get string descriptor", "<addr> <id> <index>"),
		      cmd_desc_string, 4, 0),
...
SHELL_STATIC_SUBCMD_SET_CREATE(feature_set_cmds,
	SHELL_CMD_ARG(rwup, NULL,
		      SHELL_HELP("Set remote wakeup feature", "<addr>"),
		      cmd_feature_set_rwup, 2, 0),
	SHELL_CMD_ARG(ppwr, NULL,
		      SHELL_HELP("Set port power feature", "<addr> <port>"),
		      cmd_feature_set_ppwr, 3, 0),
	SHELL_CMD_ARG(prst, NULL,
		      SHELL_HELP("Set port reset feature", "<addr> <port>"),
		      cmd_feature_set_prst, 3, 0),
	SHELL_CMD_ARG(halt, NULL,
		      SHELL_HELP("Set endpoint halt feature", "<addr> <endpoint>"),
...
SHELL_STATIC_SUBCMD_SET_CREATE(feature_clear_cmds,
	SHELL_CMD_ARG(rwup, NULL,
		      SHELL_HELP("Clear remote wakeup feature", "<addr>"),
		      cmd_feature_clear_rwup, 2, 0),
	SHELL_CMD_ARG(halt, NULL,
		      SHELL_HELP("Clear endpoint halt feature", "<addr> <endpoint>"),
...
SHELL_STATIC_SUBCMD_SET_CREATE(config_cmds,
	...
	SHELL_CMD_ARG(set, NULL,
		      SHELL_HELP("Set configuration", "<addr> <configuration>"),
		      cmd_config_set, 3, 0),
	SHELL_SUBCMD_SET_END
);
...
SHELL_STATIC_SUBCMD_SET_CREATE(device_cmds,
	SHELL_CMD_ARG(list, NULL,
		      SHELL_HELP("List USB devices", ""),
		      cmd_device_list, 1, 0),
	SHELL_CMD_ARG(address, NULL,
		      SHELL_HELP("Set device address", "<address> <new_address>"),
		      cmd_device_address, 3, 0),
	SHELL_CMD_ARG(config, &config_cmds,
		      SHELL_HELP("Configuration commands", "<get|set>"),
		      NULL, 2, 0),
	SHELL_CMD_ARG(interface, NULL,
		      SHELL_HELP("Set interface alternate setting",
				 "<address> <interface> <alternate>"),
		      cmd_device_interface, 4, 0),
	SHELL_CMD_ARG(descriptor, &desc_cmds,
		      SHELL_HELP("Descriptor requests", "<device|configuration|string>"),
		      NULL, 2, 0),
	SHELL_CMD_ARG(feature-set, &feature_set_cmds,
		      SHELL_HELP("Set feature", "<rwup|ppwr|prst|halt>"),
		      NULL, 2, 0),
	SHELL_CMD_ARG(feature-clear, &feature_clear_cmds,
		      SHELL_HELP("Clear feature", "<rwup|halt>"),
		      NULL, 2, 0),
	SHELL_CMD_ARG(vendor_in, NULL,
		      SHELL_HELP("Vendor IN request", "<address> <length>"),
		      cmd_vendor_in, 3, 0),
	SHELL_CMD_ARG(vendor_out, NULL,
		      SHELL_HELP("Vendor OUT request", "<address> <length>"),
		      cmd_vendor_out, 3, 0),
	SHELL_CMD_ARG(bulk, NULL,
		      SHELL_HELP("Bulk transfer", "<address> <endpoint> <length>"),
		      cmd_bulk, 4, 0),
	SHELL_SUBCMD_SET_END
);

SHELL_STATIC_SUBCMD_SET_CREATE(bus_cmds,
	SHELL_CMD_ARG(suspend, NULL,
		      SHELL_HELP("Suspend USB bus", ""),
		      cmd_bus_suspend, 1, 0),
	SHELL_CMD_ARG(resume, NULL,
		      SHELL_HELP("Resume USB bus", ""),
		      cmd_bus_resume, 1, 0),
	SHELL_CMD_ARG(reset, NULL,
		      SHELL_HELP("Reset USB bus", ""),
		      cmd_bus_reset, 1, 0),
	SHELL_SUBCMD_SET_END
);
...
SHELL_STATIC_SUBCMD_SET_CREATE(sub_usbh_cmds,
	SHELL_CMD_ARG(init, NULL,
		      SHELL_HELP("Initialize USB host", ""),
		      cmd_usbh_init, 1, 0),
	SHELL_CMD_ARG(enable, NULL,
		      SHELL_HELP("Enable USB host", ""),
		      cmd_usbh_enable, 1, 0),
	SHELL_CMD_ARG(disable, NULL,
		      SHELL_HELP("Disable USB host", ""),
		      cmd_usbh_disable, 1, 0),
	SHELL_CMD_ARG(bus, &bus_cmds,
		      SHELL_HELP("Bus commands", "<suspend|resume|reset>"),
		      NULL, 1, 0),
	SHELL_CMD_ARG(device, &device_cmds,
		      SHELL_HELP("Device commands",
				 "<list|address|config|interface|descriptor|feature-set|feature-clear|vendor_in|vendor_out|bulk>"),
		      NULL, 1, 0),
	SHELL_SUBCMD_SET_END
);
