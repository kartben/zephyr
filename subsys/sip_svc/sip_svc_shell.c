...
SHELL_STATIC_SUBCMD_SET_CREATE(
	...
	SHELL_CMD_ARG(reg, NULL,
		      SHELL_HELP("Register client", "<method>"),
		      cmd_reg, 2, 0),
	SHELL_CMD_ARG(unreg, NULL,
		      SHELL_HELP("Unregister client", "<method> <token>"),
		      cmd_unreg, 3, 0),
	SHELL_CMD_ARG(open, NULL,
		      SHELL_HELP("Open session", "<method> <token> [<timeout_msec>]"),
		      cmd_open, 3, 1),
	SHELL_CMD_ARG(close, NULL,
		      SHELL_HELP("Close session", "<method> <token>"),
		      cmd_close, 3, 0),
	SHELL_CMD_ARG(send, NULL,
		      SHELL_HELP("Send SIP service request",
				 "<method> <token> <a0> [<a1> <a2> ... <a7>]"),
		      cmd_send, 4, 7),
	SHELL_CMD_ARG(info, NULL,
		      SHELL_HELP("Get SIP service info", "<method>"),
		      cmd_info, 2, 0),
