...
SHELL_STATIC_SUBCMD_SET_CREATE(ieee802154_commands,
	SHELL_CMD(ack, NULL,
		  SHELL_HELP("Set auto-ack flag", "<set/1 | unset/0>"),
		  cmd_ieee802154_ack),
	SHELL_CMD(associate, NULL,
		  SHELL_HELP("Associate to network", "<pan_id> <PAN coordinator short or long address (EUI-64)>"),
		  cmd_ieee802154_associate),
	SHELL_CMD(disassociate,	NULL,
		  SHELL_HELP("Disassociate from network", ""),
		  cmd_ieee802154_disassociate),
	SHELL_CMD(get_chan, NULL,
		  SHELL_HELP("Get currently used channel", ""),
		  cmd_ieee802154_get_chan),
	SHELL_CMD(get_ext_addr,	NULL,
		  SHELL_HELP("Get currently used extended address", ""),
		  cmd_ieee802154_get_ext_addr),
	SHELL_CMD(get_pan_id, NULL,
		  SHELL_HELP("Get currently used PAN id", ""),
		  cmd_ieee802154_get_pan_id),
	SHELL_CMD(get_short_addr, NULL,
		  SHELL_HELP("Get currently used short address", ""),
		  cmd_ieee802154_get_short_addr),
	SHELL_CMD(get_tx_power,	NULL,
		  SHELL_HELP("Get currently used TX power", ""),
		  cmd_ieee802154_get_tx_power),
	SHELL_CMD(scan,	NULL,
		  SHELL_HELP("Scan for networks", "<passive|active> <channels set n[:m:...]:x|all> <per-channel duration in ms>"),
		  cmd_ieee802154_scan),
	SHELL_CMD(set_chan, NULL,
		  SHELL_HELP("Set used channel", "<channel>"),
		  cmd_ieee802154_set_chan),
	SHELL_CMD(set_ext_addr,	NULL,
		  SHELL_HELP("Set extended address", "<long/extended address (EUI-64)>"),
		  cmd_ieee802154_set_ext_addr),
	SHELL_CMD(set_pan_id, NULL,
		  SHELL_HELP("Set used PAN id", "<pan_id>"),
		  cmd_ieee802154_set_pan_id),
	SHELL_CMD(set_short_addr, NULL,
		  SHELL_HELP("Set short address", "<short address>"),
		  cmd_ieee802154_set_short_addr),
	SHELL_CMD(set_tx_power,	NULL,
		  SHELL_HELP("Set TX power", "<-18/-7/-4/-2/0/1/2/3/5>"),
