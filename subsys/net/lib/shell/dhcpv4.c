...
SHELL_STATIC_SUBCMD_SET_CREATE(net_cmd_dhcpv4,
	SHELL_CMD(server, &net_cmd_dhcpv4_server,
		  SHELL_HELP("DHCPv4 server service management.", NULL),
		  NULL),
	SHELL_CMD(client, &net_cmd_dhcpv4_client,
		  SHELL_HELP("DHCPv4 client management.", NULL),
		  NULL),
	SHELL_SUBCMD_SET_END
);

SHELL_SUBCMD_ADD((net), dhcpv4, &net_cmd_dhcpv4,
		 SHELL_HELP("Manage DHCPv4 services.", NULL),
		 NULL, 1, 0);
