...
SHELL_STATIC_SUBCMD_SET_CREATE(
	sub_task_wdt,
	SHELL_CMD(init, NULL,
		  SHELL_HELP("Initialize task watchdog", ""),
		  cmd_init),
	SHELL_CMD(add, NULL,
		  SHELL_HELP("Install new timeout", "<time_in_seconds>"),
		  cmd_add),
	SHELL_CMD(feed, NULL,
		  SHELL_HELP("Feed specified watchdog channel", "<channel_id>"),
		  cmd_feed),
	SHELL_CMD(del, NULL,
		  SHELL_HELP("Delete task watchdog channel", "<channel_id>"),
		  cmd_del),
