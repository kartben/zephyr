...
#define BT_HAS_OP_READ_PRESET_REQ        0x01U
#define BT_HAS_OP_READ_PRESET_RSP        0x02U
#define BT_HAS_OP_PRESET_CHANGED         0x03U
#define BT_HAS_OP_WRITE_PRESET_NAME      0x04U
#define BT_HAS_OP_SET_ACTIVE_PRESET      0x05U
#define BT_HAS_OP_SET_NEXT_PRESET        0x06U
#define BT_HAS_OP_SET_PREV_PRESET        0x07U
#define BT_HAS_OP_SET_ACTIVE_PRESET_SYNC 0x08U
#define BT_HAS_OP_SET_NEXT_PRESET_SYNC   0x09U
#define BT_HAS_OP_SET_PREV_PRESET_SYNC   0x0AU

/* Application error codes */
#define BT_HAS_ERR_INVALID_OPCODE         0x80U
#define BT_HAS_ERR_WRITE_NAME_NOT_ALLOWED 0x81U
#define BT_HAS_ERR_PRESET_SYNC_NOT_SUPP   0x82U
#define BT_HAS_ERR_OPERATION_NOT_POSSIBLE 0x83U
#define BT_HAS_ERR_INVALID_PARAM_LEN      0x84U

/* Hearing Aid Feature bits */
#define BT_HAS_FEAT_HEARING_AID_TYPE_LSB  BIT(0U)
#define BT_HAS_FEAT_HEARING_AID_TYPE_MSB  BIT(1U)
#define BT_HAS_FEAT_PRESET_SYNC_SUPP      BIT(2U)
#define BT_HAS_FEAT_INDEPENDENT_PRESETS   BIT(3U)
#define BT_HAS_FEAT_DYNAMIC_PRESETS       BIT(4U)
#define BT_HAS_FEAT_WRITABLE_PRESETS_SUPP BIT(5U)
...
#define BT_HAS_CHANGE_ID_GENERIC_UPDATE     0x00U
#define BT_HAS_CHANGE_ID_PRESET_DELETED     0x01U
#define BT_HAS_CHANGE_ID_PRESET_AVAILABLE   0x02U
#define BT_HAS_CHANGE_ID_PRESET_UNAVAILABLE 0x03U

#define BT_HAS_IS_LAST 0x01U
