...
#ifndef ZEPHYR_BT_CONTROLLER_LL_SW_NORDIC_LLL_LLL_META_H_
#define ZEPHYR_BT_CONTROLLER_LL_SW_NORDIC_LLL_LLL_META_H_
...
#endif /* ZEPHYR_BT_CONTROLLER_LL_SW_NORDIC_LLL_LLL_META_H_ */
