...
static int shell_out_func(int c, void *ctx)
{
...
{
	(void)cbvprintf(shell_out_func, (void *)sh_fprintf, fmt, args);
...
{
	(void)cbpprintf(shell_out_func, (void *)sh_fprintf, package);
