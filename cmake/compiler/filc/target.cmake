...
# Configuration for fil-c compiler
...
if(DEFINED TOOLCHAIN_HOME)
  set(find_program_filc_args PATHS ${TOOLCHAIN_HOME} NO_DEFAULT_PATH)
endif()
...
if(NOT "${ARCH}" STREQUAL "posix")
  ...
  # fil-c will use a default sysroot for selection of the C library.
  # fil-c supports using an alternative C library, either by direct linking,
  ...
  if(CONFIG_PICOLIBC)
    file(GLOB_RECURSE picolibc_cfg ${FILC_TOOLCHAIN_PATH}/picolibc.cfg)
    if(picolibc_cfg)
