...
function(zephyr_linker_sources location)
  ...
  if(NOT DEFINED registered)
    set_property(GLOBAL PROPERTY snippet_files
      ${sections_path} ${rom_sections_path} ${ram_sections_path}
      ${data_sections_path} ${text_sections_path} ${rom_start_path} ${bss_path}
      ${noinit_path} ${rwdata_path} ${rodata_path} ${ramfunc_path}
      ${nocache_path} ${itcm_path} ${dtcm_path}
      )
