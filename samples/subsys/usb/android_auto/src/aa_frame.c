...
LOG_MODULE_REGISTER(aa_frame, CONFIG_SAMPLE_AA_LOG_LEVEL);

/* Largest plaintext handed to the TLS layer per frame */
#define TX_CHUNK_SIZE CONFIG_SAMPLE_AA_TX_CHUNK_SIZE
...
BUILD_ASSERT(CONFIG_SAMPLE_AA_RX_FRAME_SIZE >= CONFIG_MBEDTLS_SSL_IN_CONTENT_LEN + 29,
...
static uint8_t rx_frame[CONFIG_SAMPLE_AA_RX_FRAME_SIZE];
