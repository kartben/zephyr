.. zephyr:code-sample:: sockets-tcp-sample
   :name: TCP sample for TTCN-3 based validation
...
This application is used together with the TTCN-3 based validation
...
Compile and run the TCP validation `net-test-suites`_:
