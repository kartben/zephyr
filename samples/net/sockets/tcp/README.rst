.. zephyr:code-sample:: sockets-tcp-sample
   :name: TCP sample for TTCN-3 based testing
...
This application is used together with the TTCN-3 based test suite
to validate the functionality of the TCP.

Building, Running and executing TTCN-3 based Tests for TCP
**********************************************************
...
Compile and run the TCP test suite `net-test-suites`_:
