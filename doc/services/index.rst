...
.. grid:: 1 1 2 2
    ...
    .. grid-item-card:: :material-twotone:`bug_report;36px` Debugging & Observability
        :link: debugging_observability_services
        :link-type: ref
    ...
    .. grid-item-card:: :material-twotone:`import_export;36px` Input / Output
        ...
        Console, input devices abstraction, and other I/O utilities.
    ...
    .. grid-item-card:: :material-twotone:`chat_bubble;36px` Communication
