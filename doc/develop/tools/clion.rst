...
#. Click :menuselection:`Add environment --> From file` and select
   ...
   .. figure:: img/toolchain_mingw.webp
      :width: 600px
      :align: center
...
#. Configure the settings:
    ...
    .. figure:: img/gdbserverconfig.webp
       :width: 500px
       :align: center
...
#. Click :guilabel:`Next` to set the Segger J-Link parameters.
    ...
    .. figure:: img/segger_settings.webp
       :width: 500px
       :align: center
