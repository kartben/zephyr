...
* Flash
  ...
  * :kconfig:option:`CONFIG_FLASH_STM32_XSPI` has been deprecated on the STM32H5
    series in favor of the MSPI driver selected by
    :kconfig:option:`CONFIG_MSPI_STM32_XSPI`.
