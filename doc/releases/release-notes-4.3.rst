...
**Developer Experience Improvements**
  ...
  * :ref:`dtdoctor <dtdoctor>` - Static analysis tool for diagnosing Devicetree-related build errors
  * :ref:`traceconfig <kconfig-tracing>` - Build target to trace Kconfig symbol values to their source
  * :ref:`ram_plot/rom_plot <footprint_tools>` - Interactive sunburst charts for visualizing memory usage

**Twister Display Harness**
  Twister can now validate on-target display output by
