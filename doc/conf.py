...
# The Kapa.ai AI assistant widget is only embedded when a website ID is provided, see the
# KAPA_WEBSITE_ID option in doc/CMakeLists.txt.
# See https://docs.kapa.ai/integrations/website-widget/installation/general
kapa_website_id = os.environ.get("KAPA_WEBSITE_ID", "")
if kapa_website_id:
    html_context["kapa_website_id"] = kapa_website_id
...
doxyrunner_projects = {
    "zephyr": {
        ...
        "fmt_vars": {
            ...
            # Generated by doc/CMakeLists.txt, which decides whether the Kapa.ai widget is part of
            # the header.
            "DOXYGEN_HTML_HEADER": os.environ["DOXYGEN_HTML_HEADER"],
        },
        "outdir_var": "DOXY_OUT",
    },
}
