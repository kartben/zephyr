...
start of 1970 UTC). UNIX Time (see :rfc:`8536#section-2`) is an extension of POSIX
...
The continuous analogue is UNIX Leap Time (see :rfc:`8536#section-2`) which is UNIX time plus all
