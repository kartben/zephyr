...
.. zephyr:soc-series:: esp32c6

ESP32C6 SoC Series
##################

This page provides shared documentation for the :zephyr:soc-series:`esp32c6` series in
the :zephyr:soc-family:`espressif_esp32` family.

.. zephyr:soc-fragment:: soc-features
   ...
   For more information, check the `ESP32-C6 Datasheet`_ or the `ESP32-C6 Technical Reference Manual`_.
