...
* **MOSI (Main Out Secondary In)**: Data line from controller to peripheral (also called SDO - Serial Data Out)
* **MISO (Main In Secondary Out)**: Data line from peripheral to controller (also called SDI - Serial Data In)
* **CS (Chip Select)**: Signal to select a specific peripheral device
