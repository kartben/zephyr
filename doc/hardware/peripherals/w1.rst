...
exchanges with the target devices.
...
Zephyr's 1-Wire Controller API is used to interact with 1-Wire target devices like
...
* The 1-Wire network layer handles all means for slave identification and bus
   ...
   * All target devices have a unique 64-bit identification number, which
