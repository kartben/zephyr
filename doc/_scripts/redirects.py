...
REDIRECTS = (
    ...
    ('kernel/data_structures/dlist', 'services/data_structures/dlist'),
    ('kernel/data_structures/index', 'services/data_structures/index'),
    ('kernel/data_structures/min_heap', 'services/data_structures/min_heap'),
    ('kernel/data_structures/mpsc_lockfree', 'services/data_structures/mpsc_lockfree'),
    ('kernel/data_structures/mpsc_pbuf', 'services/data_structures/mpsc_pbuf'),
    ('kernel/data_structures/rbtree', 'services/data_structures/rbtree'),
    ('kernel/data_structures/ring_buffers', 'services/data_structures/ring_buffers'),
    ('kernel/data_structures/slist', 'services/data_structures/slist'),
    ('kernel/data_structures/spsc_lockfree', 'services/data_structures/spsc_lockfree'),
    ('kernel/data_structures/spsc_pbuf', 'services/data_structures/spsc_pbuf'),
    ...
    ('samples/shields/npm13xx_ek/doc/index', 'samples/shields/npm13xx_ek/index'),
    ('samples/shields/npm2100_ek/doc/index', 'samples/shields/npm2100_ek/index'),
