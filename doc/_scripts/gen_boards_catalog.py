...
from gen_devicetree_rest import VndLookup, binding_type_from_path
        ...
        if board.name in board_devicetrees:
            for board_target, edt in board_devicetrees[board.name].items():
                ...
                for node in edt.nodes:
                    ...
                    binding_type = binding_type_from_path(node.binding_path)
                    is_custom_binding = binding_type is None
                    if is_custom_binding:
                        binding_type = "misc"
