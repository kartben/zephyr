...
def main():
    ...
    # right now, turbo mode is a no-op, but it will be used in the future as "full" catalog
    # generation will increase in complexity
    ...
    for board in boards:
        ...
        if not full_name:
            ...
            # the title in the board's documentation page.
